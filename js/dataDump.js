...
async def main():
	...
	try: 
		if externalSQL: conn = MySQLdb.connect("REDACTED", "REDACTED", "REDACTED", "REDACTED")
		else: conn = MySQLdb.connect("REDACTED", "REDACTED", "REDACTED", "REDACTED")
	except: 
